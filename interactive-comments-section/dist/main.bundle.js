...
;// CONCATENATED MODULE: ./src/features/commentsSlice.js
...
var commentsSlice = createSlice({
  ...
  reducers: {
    ...
    addPost: function addPost(state, action) {
      var _action$payload$;
      var posts = state.value.comments;
      if (((_action$payload$ = action.payload[1]) === null || _action$payload$ === void 0 ? void 0 : _action$payload$.isReply) === true) {
        for (var i = 0; i < posts.length; i++) {
          var _action$payload$2;
          if (posts[i].id == ((_action$payload$2 = action.payload[1]) === null || _action$payload$2 === void 0 ? void 0 : _action$payload$2.postId)) {
    ...
    vote: function vote(state, action) {
      var postId = action.payload.id;
      var data = state.value.comments;
    ...
    deletePost: function deletePost(state, action) {
      var postId = action.payload;
      var data = state.value.comments;
      var filteredComments = data.filter(function (comment) {
      ...
      if (data.length === filteredComments.length) {
        for (var i = 0; i < data.length; i++) {
          var _data$i;
          if ((_data$i = data[i]) !== null && _data$i !== void 0 && _data$i.replies && data[i].replies.length !== 0) {
            var filteredReplies = data[i].replies.filter(function (reply) {
...
var _commentsSlice$action = commentsSlice.actions,
  save = _commentsSlice$action.save,
  addPost = _commentsSlice$action.addPost,
  vote = _commentsSlice$action.vote,
  update = _commentsSlice$action.update,
  deletePost = _commentsSlice$action.deletePost;

/* harmony default export */ const features_commentsSlice = (commentsSlice.reducer);
;// CONCATENATED MODULE: ./src/store.js


/* harmony default export */ const store = (configureStore({
  reducer: {
    posts: features_commentsSlice
  }
}));
// EXTERNAL MODULE: ./node_modules/react/jsx-runtime.js
var jsx_runtime = __webpack_require__(893);
;// CONCATENATED MODULE: ./src/features/SendPost/SendPost.js
...
var SendPost = /*#__PURE__*/(0,react.forwardRef)(function (_ref, ref) {
  ...
  var addPostHandler = function addPostHandler() {
    if (isReply) {
      dispatch(addPost([{
        id: nanoid(),
        content: postContent,
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      className: "m-5 p-5 bg-white  flex-row flex flex-wrap gap-x-5 justify-between items-center md:items-start rounded-xl",
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        className: "mt-4 md:mt-0 h-8 w-8  bg-black rounded-full"
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        className: "-order-1 basis-full md:order-none md:basis-auto md:grow",
...
/* harmony default export */ const SendPost_SendPost = (SendPost);
;// CONCATENATED MODULE: ./src/features/DisplayPost/Vote.js
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        ...
        className: "bg-cgrey  w-10 h-11 py-2.5 text-cmblue font-bold text-center cursor-not-allowed",
        children: score
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
...
;// CONCATENATED MODULE: ./src/features/Modal/Modal.js
...
function Modal(_ref) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
    children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: "grid place-items-center h-screen w-screen bg-slate-300/50 fixed top-0",
      children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        className: "w-11/12 md:w-96  p-5 bg-white rounded-lg",
...
;// CONCATENATED MODULE: ./src/features/DisplayPost/Post.js
...
var Post = function Post(_ref) {
  ...
  var _useState5 = (0,react.useState)(false),
    _useState6 = Post_slicedToArray(_useState5, 2),
    showEdit = _useState6[0],
    setShowEdit = _useState6[1];
  var _useState7 = (0,react.useState)(data.content),
    _useState8 = Post_slicedToArray(_useState7, 2),
    editedPost = _useState8[0],
    setEditedPost = _useState8[1];
  var childRef = (0,react.useRef)(null);
  var dispatch = useDispatch();
  var owner = currentUser === data.user.username ? true : false;
  var portalContainer = document.getElementById("reply-id-".concat(data.id));
  var isPostCSS = 'relative my-5 mx-5 p-5 bg-white rounded-xl';
  var isReplyCSS = 'relative mt-4 mx-5 p-5 bg-white rounded-xl';
  var toggleShowReply = function toggleShowReply() {
    setShowReply(!showReply);
  };
  var toggleShowEdit = function toggleShowEdit() {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        className: "flex flex-col gap-y-2 md:grid md:grid-cols-12 md:grid-rows-2 md:gap-x-6 md:content-start",
        children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          className: "order-last md:order-first md:row-span-2 md:col-span-1",
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            ...
            className: "leading-6 ml-3 px-2 max-h-6 bg-cmblue text-white",
            children: "you"
          }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            className: "leading-8 ml-3",
            children: data.createdAt
          })]
        }), !showEdit && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          className: "my-3 md:col-span-10 md:items-start md:-mt-6",
          children: data.content
        }), showEdit && /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
          className: "my-3 md:col-span-10 md:items-start md:-mt-14",
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)("textarea", {
            ...
            onChange: function onChange(e) {
              return setEditedPost(e.target.value);
            },
            className: "w-full resize-none rounded-md px-4 py-2 ring-1 ring-gray-300 focus:ring-2 focus:ring-csred"
          }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            onClick: function onClick() {
        ...
        className: "absolute h-10 flex flex-row gap-4 items-center bottom-6 right-5 md:top-4",
        children: [owner && /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
          children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
            ...
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)("svg", {
              ...
              className: "text-csred group-hover:text-[#ffcccf]",
              children: "Delete"
            })]
          }), /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
            className: "group flex flex-row items-center gap-2 cursor-pointer",
            onClick: function onClick() {
              return toggleShowEdit();
            },
            children: [/*#__PURE__*/(0,jsx_runtime.jsx)("svg", {
              width: "14",
              height: "13",
              ...
              className: "group-hover:text-clgblue",
              children: "Edit"
            })]
          })]
        }), showModal && /*#__PURE__*/(0,react_dom.createPortal)( /*#__PURE__*/(0,jsx_runtime.jsx)(Modal, {
          postId: data.id,
          onClose: function onClose() {
            return setShowModal(false);
          }
        }), document.body), isPost && !showReply && /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
          className: "group flex flex-row items-center gap-2 cursor-pointer",
          onClick: function onClick() {
    ...
    }), showReply && /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        className: "mt-5",
        id: "reply-id-".concat(data.id)
      }), /*#__PURE__*/(0,jsx_runtime.jsx)(SendPost_SendPost, {
        ref: childRef,
        isReply: true,
        data: data,
...
/* harmony default export */ const DisplayPost_Post = (Post);
;// CONCATENATED MODULE: ./src/features/DisplayPosts/DisplayPosts.js
...
function DisplayPosts() {
  ...
  var sortedComments = deepCopy(data.comments);
  sortedComments.sort(function (a, b) {
    return b.score - a.score;
  });
  for (var i = 0; i < sortedComments.length; i++) {
    if (sortedComments[i].replies != null && sortedComments[i].replies.length > 0) {
      sortedComments[i].replies = sortedComments[i].replies.slice().sort(function (a, b) {
        return b.score - a.score;
      });
    }
  }
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    children: /*#__PURE__*/(0,jsx_runtime.jsx)("ul", {
      children: sortedComments.map(function (post) {
        return /*#__PURE__*/(0,jsx_runtime.jsxs)("li", {
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)(DisplayPost_Post, {
            data: post,
            isPost: true,
            currentUser: currentUser
          }, post.id), post.replies.length > 0 && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            children: /*#__PURE__*/(0,jsx_runtime.jsx)("ul", {
              children: post.replies.map(function (reply) {
...
var App = function App() {
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)(DisplayPosts, {}), /*#__PURE__*/(0,jsx_runtime.jsx)(SendPost_SendPost, {})]
  });
};
...
client.createRoot(document.getElementById('root')).render( /*#__PURE__*/(0,jsx_runtime.jsx)(components_Provider, {
  store: store,
