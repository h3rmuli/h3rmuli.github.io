...
;// CONCATENATED MODULE: ./src/features/surveyResultSlice.js

var surveyResultSlice = createSlice({
  name: 'survey',
  initialState: {
    value: 0
  },
  reducers: {
    setPoints: function setPoints(state, action) {
      state.value = action.payload;
    }
  }
});
var setPoints = surveyResultSlice.actions.setPoints;

var selectSurveyResult = function selectSurveyResult(state) {
  return state.survey.value;
};
/* harmony default export */ const features_surveyResultSlice = (surveyResultSlice.reducer);
;// CONCATENATED MODULE: ./src/store.js


/* harmony default export */ const store = (configureStore({
  reducer: {
    survey: features_surveyResultSlice
  }
}));
...
;// CONCATENATED MODULE: ./src/components/Point.js

function Point(_ref) {
  var value = _ref.value,
    handler = _ref.handler,
    active = _ref.active;
  var css = active == value ? 'bg-slate-400 rounded-full flex items-center justify-center w-12 h-12 text-white hover:bg-orange-400 hover:text-white transition duration-300' : 'bg-slate-700 rounded-full flex items-center justify-center w-12 h-12 text-neutral-300 hover:bg-orange-400 hover:text-white transition duration-300';
...
;// CONCATENATED MODULE: ./src/components/Survey.js
...
function Survey() {
  ...
  var _useState = (0,react.useState)(),
    ...
    selectedPoints = _useState2[0],
    setSelectedPoints = _useState2[1];
  console.log('selectedPoints', selectedPoints);
  var handleClick = function handleClick(e) {
    e.preventDefault();
    dispatch(setPoints(selectedPoints));
  };
  var handlePoints = function handlePoints(e) {
    e.preventDefault();
    setSelectedPoints(e.target.dataset.testing);
  };
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: "bg-slate-800 m-5 p-5 rounded-lg",
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: "bg-slate-600 rounded-full flex items-center justify-center w-12 h-12",
      ...
      className: "text-2xl font-medium mt-7 text-white",
      ...
      children: [1, 2, 3, 4, 5].map(function (value) {
        return /*#__PURE__*/(0,jsx_runtime.jsx)(Point, {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    ...
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("svg", {
        ...
        className: "bg-slate-600 text-orange-400 text-sm py-1 px-3 mt-7 rounded-full",
        children: ["You selected ", count, " out of 5"]
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("h1", {
        className: "text-center text-white font-medium mt-4 text-2xl",
        children: "Thank you!"
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("p", {
        className: "text-neutral-400 mt-3 text-base",
