...
;// CONCATENATED MODULE: ./src/components/emailSlice.js

var emailSlice = createSlice({
  name: 'email',
  initialState: {
    value: ''
  },
...
var set = emailSlice.actions.set;

/* harmony default export */ const components_emailSlice = (emailSlice.reducer);
;// CONCATENATED MODULE: ./src/components/componentsSlice.js

var componentsSlice = createSlice({
  name: 'components',
  initialState: {
    value: {
      content: true,
  ...
  reducers: {
    cmpShow: function cmpShow(state, action) {
      state.value[action.payload] = true;
    },
    cmpHide: function cmpHide(state, action) {
      state.value[action.payload] = false;
    }
  }
});
var _componentsSlice$acti = componentsSlice.actions,
  cmpShow = _componentsSlice$acti.cmpShow,
  cmpHide = _componentsSlice$acti.cmpHide;

/* harmony default export */ const components_componentsSlice = (componentsSlice.reducer);
...
/* harmony default export */ const store = (configureStore({
  reducer: {
    email: components_emailSlice,
    components: components_componentsSlice
  }
}));
...
;// CONCATENATED MODULE: ./src/components/Hero_Mobile.js


function Hero_Mobile() {
  return /*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
    children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: "bg-hero-mobile h-[284px] bg-cover rounded-b-2xl"
    })
  });
}
;// CONCATENATED MODULE: ./src/components/Hero_Laptop.js


function Hero_Laptop() {
  return /*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
    children: /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: "bg-hero-desktop h-[500px] bg-contain bg-center bg-no-repeat rounded-b-2xl"
    })
  });
}
...
function Hero() {
  ...
  if (laptop) {
    return /*#__PURE__*/(0,jsx_runtime.jsx)(Hero_Laptop, {});
  } else {
    return /*#__PURE__*/(0,jsx_runtime.jsx)(Hero_Mobile, {});
  }
}
...
function Subscribe() {
  ...
  var validInputCSS = 'block w-full rounded-md mt-2 py-3 pl-3 h-12 border-0 ring-1 ring-black';
  var invalidInputCSS = 'block w-full rounded-md mt-2 py-3 pl-3 h-12 border-0 ring-1 ring-red-500 bg-red-100';
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    }), !emailValid ? /*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
      children: /*#__PURE__*/(0,jsx_runtime.jsx)("label", {
        htmlFor: "emailAddress",
        className: "float-right text-red-500",
        children: "Valid email required"
      })
    }) : null, /*#__PURE__*/(0,jsx_runtime.jsx)("input", {
      type: "text",
      id: "emailAddress",
...
function Content() {
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    ...
    }), /*#__PURE__*/(0,jsx_runtime.jsx)(Subscribe, {})]
  });
}
;// CONCATENATED MODULE: ./src/components/ThankYou.js
...
function thankYou() {
  var emailAdress = useSelector(function (state) {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      className: "h-screen md:h-1/3 w-full md:w-1/2 py-6 px-10 md:items-center bg-white rounded-xl",
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("svg", {
        ...
        children: ["A confirmation email has been sent to", ' ', /*#__PURE__*/(0,jsx_runtime.jsx)("span", {
          className: "font-semibold",
          children: emailAdress
...
var App = function App() {
  var content = useSelector(function (state) {
    return state.components.value.content;
  });
  var thanks = useSelector(function (state) {
    return state.components.value.thankYou;
  });
  console.log(content);
  return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
    className: "h-screen flex items-center lg:w-8/12 xl:w-6/12 mx-auto bg-charcoal",
    children: [content === true ? /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
      className: "grid grid-cols-1 md:grid-cols-2 h-screen md:h-2/3 md:items-center bg-white rounded-xl",
    ...
    }) : null, thanks === true ? /*#__PURE__*/(0,jsx_runtime.jsx)(thankYou, {}) : null]
  });
};
...
client.createRoot(document.getElementById('root')).render( /*#__PURE__*/(0,jsx_runtime.jsxs)(components_Provider, {
  store: store,
