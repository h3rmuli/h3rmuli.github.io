...
;// CONCATENATED MODULE: ./src/features/cartSlice.js
...
var cartSlice = createSlice({
  ...
  reducers: {
    addProduct: {
      reducer: function reducer(state, action) {
        if (action.payload.quantity !== 0) {
          var exists = state.value.find(function (item) {
    ...
    removeProduct: function removeProduct(state, action) {
      var temp = state.value.filter(function (item) {
        return item.id === action.payload.id;
      });
      state.value = temp;
    }
...
/* harmony default export */ const features_cartSlice = (cartSlice.reducer);
;// CONCATENATED MODULE: ./src/store.js


/* harmony default export */ const store = (configureStore({
  reducer: {
    cart: features_cartSlice
  }
}));
...
;// CONCATENATED MODULE: ./src/components/MobileNavigation.js
function MobileNavigation_slicedToArray(arr, i) { return MobileNavigation_arrayWithHoles(arr) || MobileNavigation_iterableToArrayLimit(arr, i) || MobileNavigation_unsupportedIterableToArray(arr, i) || MobileNavigation_nonIterableRest(); }
function MobileNavigation_nonIterableRest() { throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method."); }
function MobileNavigation_unsupportedIterableToArray(o, minLen) { if (!o) return; if (typeof o === "string") return MobileNavigation_arrayLikeToArray(o, minLen); var n = Object.prototype.toString.call(o).slice(8, -1); if (n === "Object" && o.constructor) n = o.constructor.name; if (n === "Map" || n === "Set") return Array.from(o); if (n === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(n)) return MobileNavigation_arrayLikeToArray(o, minLen); }
function MobileNavigation_arrayLikeToArray(arr, len) { if (len == null || len > arr.length) len = arr.length; for (var i = 0, arr2 = new Array(len); i < len; i++) arr2[i] = arr[i]; return arr2; }
function MobileNavigation_iterableToArrayLimit(arr, i) { var _i = null == arr ? null : "undefined" != typeof Symbol && arr[Symbol.iterator] || arr["@@iterator"]; if (null != _i) { var _s, _e, _x, _r, _arr = [], _n = !0, _d = !1; try { if (_x = (_i = _i.call(arr)).next, 0 === i) { if (Object(_i) !== _i) return; _n = !1; } else for (; !(_n = (_s = _x.call(_i)).done) && (_arr.push(_s.value), _arr.length !== i); _n = !0); } catch (err) { _d = !0, _e = err; } finally { try { if (!_n && null != _i["return"] && (_r = _i["return"](), Object(_r) !== _r)) return; } finally { if (_d) throw _e; } } return _arr; } }
function MobileNavigation_arrayWithHoles(arr) { if (Array.isArray(arr)) return arr; }
...
function MobileNavigation(_ref) {
      ...
      children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        ...
        children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
          ...
          children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
            ...
            className: "mt-5 ml-6",
            children: entries.map(function (_ref3) {
              var _ref4 = MobileNavigation_slicedToArray(_ref3, 2),
                entry = _ref4[0],
                id = _ref4[1];
              return /*#__PURE__*/(0,jsx_runtime.jsx)("li", {
                className: "py-2 font-Kumbh-Sans text-lg font-medium",
                children: entry
              }, id);
            })
          })]
        }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          className: "fixed h-screen w-1/3 top-0 right-0 bg-slate-300/50",
          onClick: onClose
        })]
      })
    });
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    ...
    }), showMenu && /*#__PURE__*/(0,react_dom.createPortal)( /*#__PURE__*/(0,jsx_runtime.jsx)(MobileMenu, {
      entries: entries,
...
function Navigation() {
  ...
  var entries = [['Collections', 1], ['Men', 2], ['Women', 3], ['About', 4], ['Contact', 5]];
  if (laptop) {
    return /*#__PURE__*/(0,jsx_runtime.jsx)(DesktopNavigation, {
      entries: entries
    });
  } else {
    return /*#__PURE__*/(0,jsx_runtime.jsx)(MobileNavigation, {
      entries: entries
    });
  }
}
...
function Cart() {
  ...
  var Product = function Product(_ref) {
    ...
    return /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      className: "grid grid-cols-5 grid-rows-2 gap-x-2",
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        className: "row-span-2",
        children: /*#__PURE__*/(0,jsx_runtime.jsx)("img", {
          src: image_product_1_thumbnail_namespaceObject,
          className: "h-12 w-12 rounded-lg"
        })
      }), /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        className: "text-left text-sm col-span-3 truncate",
        ...
        className: "text-left text-sm col-span-3",
        children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("span", {
          className: "text-slate-500",
          children: ["$", item.price, " x ", item.quantity]
        }), /*#__PURE__*/(0,jsx_runtime.jsxs)("span", {
          className: "ml-1 font-semibold",
          children: ["$", item.totalSum]
        })]
      })]
    });
  };
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
    children: /*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsx)("div", {
        ...
        children: [cart.value.length === 0 && /*#__PURE__*/(0,jsx_runtime.jsx)("div", {
          className: "w-full h-32 leading-[8] text-center",
          children: /*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
            children: "Your cart is empty."
          })
        }), cart.value.length !== 0 && /*#__PURE__*/(0,jsx_runtime.jsx)(jsx_runtime.Fragment, {
  ...
  return /*#__PURE__*/(0,jsx_runtime.jsxs)(jsx_runtime.Fragment, {
    children: [/*#__PURE__*/(0,jsx_runtime.jsx)("h2", {
      ...
      children: [/*#__PURE__*/(0,jsx_runtime.jsxs)("div", {
        ...
        className: "flex w-full sm:w-7/12 justify-center gap-x-2 py-4 bg-ora rounded-lg mt-4 sm:mt-0 cursor-pointer",
        onClick: function onClick() {
